        ...
        {trends.map((trend, index) => (
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 8px 32px rgba(160,120,48,0.12)',
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 h-28 rounded-b-3xl bg-gradient-to-t from-[rgba(61,42,26,0.70)] to-transparent" />
